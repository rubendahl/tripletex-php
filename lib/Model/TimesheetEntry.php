...
'hourly_cost' => 'getHourlyCost'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['chargeable_hours'] === null) {
            $invalidProperties[] = "'chargeable_hours' can't be null";
        }
     ...
     * Sets hourly_rate
     *
     * @param BigDecimal $hourly_rate hourly_rate
     *
     * @return $this
     */
     ...
     * Sets hourly_cost
     *
     * @param BigDecimal $hourly_cost hourly_cost
     *
     * @return $this
     */
