...
class SalarySettings implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['payroll_tax_calc_method']) > 2)) {
    ...
    public function setPayrollTaxCalcMethod($payroll_tax_calc_method)
    {
        ...
        if ((mb_strlen($payroll_tax_calc_method) > 2)) {
            throw new \InvalidArgumentException('invalid length for $payroll_tax_calc_method when calling SalarySettings., must be smaller than or equal to 2.');
        }
