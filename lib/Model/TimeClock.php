...
class TimeClock implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['hours_start']) && ($this->container['hours_start'] < 0.0)) {
            $invalidProperties[] = "invalid value for 'hours_start', must be bigger than or equal to 0.0.";
        }
    ...
    public function setHoursStart($hours_start)
    {
        ...
        if (!is_null($hours_start) && ($hours_start < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $hours_start when calling TimeClock., must be bigger than or equal to 0.0.');
        }
