...
'amount' => 'BigDecimal',
'amount_currency' => 'BigDecimal',
'amount_excluding_vat' => 'BigDecimal',
'amount_excluding_vat_currency' => 'BigDecimal',
'amount_roundoff' => 'BigDecimal',
'amount_roundoff_currency' => 'BigDecimal',
'amount_outstanding' => 'BigDecimal',
'amount_outstanding_total' => 'BigDecimal',
'sum_remits' => 'BigDecimal',
...
self::EHF_SEND_STATUS_SEND_FAILURE_RECIPIENT_NOT_FOUND,        ];
     ...
     * Sets amount
     *
     * @param BigDecimal $amount In the company’s currency, typically NOK.
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_currency In the specified currency.
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_excluding_vat Amount excluding VAT (NOK).
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_excluding_vat_currency Amount excluding VAT in the specified currency.
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_roundoff Amount of round off to nearest integer.
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_roundoff_currency Amount of round off to nearest integer in the specified currency.
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_outstanding The amount outstanding based on the history collection, excluding reminders and any existing remits, in the invoice currency.
     *
     * @return $this
     */
     ...
     *
     * @param BigDecimal $amount_outstanding_total The amount outstanding based on the history collection and including the last reminder and any existing remits. This is the total invoice balance including reminders and remittances, in the invoice currency.
     *
     * @return $this
     */
     ...
     * Sets sum_remits
     *
     * @param BigDecimal $sum_remits The sum of all open remittances of the invoice. Remittances are reimbursement payments back to the customer and are therefore relevant to the bookkeeping of the invoice in the accounts.
     *
     * @return $this
     */
