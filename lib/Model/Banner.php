...
class Banner implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['banner_type'] === null) {
            $invalidProperties[] = "'banner_type' can't be null";
        }
        ...
        if ((mb_strlen($this->container['button']) > 255)) {
        ...
        if ((mb_strlen($this->container['tag']) > 255)) {
