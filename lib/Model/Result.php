...
class Result implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'log' => 'string[]',
        'record' => '\Tripletex\Model\CSVRecord',
        'dto' => '\Tripletex\Model\AbstractDTO'
    ];
    ...
    const FILE_DEPARTMENTS = 'DEPARTMENTS';
    const FILE_EMPLOYEES = 'EMPLOYEES';
    const FILE_VATCODES = 'VATCODES';
    const FILE_ACCOUNTS = 'ACCOUNTS';
    const FILE_CUSTOMERS = 'CUSTOMERS';
    const FILE_CUSTOMERS_CATEGORIES = 'CUSTOMERS_CATEGORIES';
    const FILE_VENDORS = 'VENDORS';
    const FILE_VENDORS_CATEGORIES = 'VENDORS_CATEGORIES';
    const FILE_CONTACTS = 'CONTACTS';
    const FILE_DELIVERY_ADDRESSES = 'DELIVERY_ADDRESSES';
    const FILE_PRODUCTS = 'PRODUCTS';
    const FILE_PRODUCTS_CATEGORIES = 'PRODUCTS_CATEGORIES';
    const FILE_PROJECTS = 'PROJECTS';
    const FILE_PROJECTS_CATEGORIES = 'PROJECTS_CATEGORIES';
    ...
    {
        return [
            self::FILE_DEPARTMENTS,
            self::FILE_EMPLOYEES,
            self::FILE_VATCODES,
            self::FILE_ACCOUNTS,
            self::FILE_CUSTOMERS,
            self::FILE_CUSTOMERS_CATEGORIES,
            self::FILE_VENDORS,
            self::FILE_VENDORS_CATEGORIES,
            self::FILE_CONTACTS,
            self::FILE_DELIVERY_ADDRESSES,
            self::FILE_PRODUCTS,
            self::FILE_PRODUCTS_CATEGORIES,
            self::FILE_PROJECTS,
            self::FILE_PROJECTS_CATEGORIES,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['db_id'] = isset($data['db_id']) ? $data['db_id'] : null;
     ...
     * Sets input
     *
     * @param map[string,object] $input input
     *
     * @return $this
     */
     ...
     * Sets output
     *
     * @param map[string,object] $output output
     *
     * @return $this
     */
     ...
     * Gets record
     *
     * @return \Tripletex\Model\CSVRecord
     */
     ...
     * Sets record
     *
     * @param \Tripletex\Model\CSVRecord $record record
     *
     * @return $this
     */
     ...
     * Gets dto
     *
     * @return \Tripletex\Model\AbstractDTO
     */
     ...
     * Sets dto
     *
     * @param \Tripletex\Model\AbstractDTO $dto dto
     *
     * @return $this
     */
