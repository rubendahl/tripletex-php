...
class Employment implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tax_deduction_code']) && (mb_strlen($this->container['tax_deduction_code']) > 255)) {
            $invalidProperties[] = "invalid value for 'tax_deduction_code', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setTaxDeductionCode($tax_deduction_code)
    {
        ...
        if (!is_null($tax_deduction_code) && (mb_strlen($tax_deduction_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tax_deduction_code when calling Employment., must be smaller than or equal to 255.');
        }
