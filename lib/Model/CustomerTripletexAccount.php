...
class CustomerTripletexAccount implements ModelInterface, ArrayAccess
{
     ...
     * Sets administrator
     *
     * @param \Tripletex\Model\Employee $administrator Administrator user to create in the new company. Leave empty if calling this enpoint as an auditor og accountant company
     *
     * @return $this
     */
