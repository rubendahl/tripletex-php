...
class BankstatementApi
{
     ...
     * @param  int $bank_id Bank ID (optional)
     *
     * @throws \Tripletex\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripletex\Model\ResponseWrapperBankStatement
     */
    public function importBankStatement($file_format, $file, $bank_id = null)
    {
        list($response) = $this->importBankStatementWithHttpInfo($file_format, $file, $bank_id);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ResponseWrapperBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function importBankStatementWithHttpInfo($file_format, $file, $bank_id = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($file_format, $file, $bank_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsync($file_format, $file, $bank_id = null)
    {
        return $this->importBankStatementAsyncWithHttpInfo($file_format, $file, $bank_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsyncWithHttpInfo($file_format, $file, $bank_id = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($file_format, $file, $bank_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importBankStatementRequest($file_format, $file, $bank_id = null)
    {
     ...
     */
    public function search($id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     */
    public function searchWithHttpInfo($id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBankStatement';
        $request = $this->searchRequest($id, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
