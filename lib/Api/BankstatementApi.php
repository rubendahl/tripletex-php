...
class BankstatementApi
{
     ...
     * @return \Tripletex\Model\ResponseWrapperBankStatement
     */
    public function importBankStatement($file_format, $file = null, $bank_id = null)
    {
     ...
     * @return array of \Tripletex\Model\ResponseWrapperBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function importBankStatementWithHttpInfo($file_format, $file = null, $bank_id = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsync($file_format, $file = null, $bank_id = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsyncWithHttpInfo($file_format, $file = null, $bank_id = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($file_format, $file, $bank_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importBankStatementRequest($file_format, $file = null, $bank_id = null)
    {
