...
class InventoryinventoriesApi
{
     ...
     */
    public function search($date_from, $date_to, $product_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     */
    public function searchWithHttpInfo($date_from, $date_to, $product_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     */
    public function searchAsync($date_from, $date_to, $product_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($date_from, $date_to, $product_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseInventories';
        $request = $this->searchRequest($date_from, $date_to, $product_id, $from, $count, $sorting, $fields);
     ...
     */
    protected function searchRequest($date_from, $date_to, $product_id = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
