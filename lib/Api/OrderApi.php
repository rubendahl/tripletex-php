...
class OrderApi
{
     ...
     */
    public function invoice($id, $invoice_date, $send_to_customer = 'true', $payment_type_id = null, $paid_amount = null)
    {
     ...
     */
    public function invoiceWithHttpInfo($id, $invoice_date, $send_to_customer = 'true', $payment_type_id = null, $paid_amount = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoiceAsync($id, $invoice_date, $send_to_customer = 'true', $payment_type_id = null, $paid_amount = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoiceAsyncWithHttpInfo($id, $invoice_date, $send_to_customer = 'true', $payment_type_id = null, $paid_amount = null)
    {
        $returnType = '\Tripletex\Model\ResponseWrapperInvoice';
        $request = $this->invoiceRequest($id, $invoice_date, $send_to_customer, $payment_type_id, $paid_amount);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function invoiceRequest($id, $invoice_date, $send_to_customer = 'true', $payment_type_id = null, $paid_amount = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function search($order_date_from, $order_date_to, $id = null, $number = null, $customer_id = null, $is_closed = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($order_date_from, $order_date_to, $id, $number, $customer_id, $is_closed, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     */
    public function searchWithHttpInfo($order_date_from, $order_date_to, $id = null, $number = null, $customer_id = null, $is_closed = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseOrder';
        $request = $this->searchRequest($order_date_from, $order_date_to, $id, $number, $customer_id, $is_closed, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($order_date_from, $order_date_to, $id = null, $number = null, $customer_id = null, $is_closed = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($order_date_from, $order_date_to, $id, $number, $customer_id, $is_closed, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($order_date_from, $order_date_to, $id = null, $number = null, $customer_id = null, $is_closed = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseOrder';
        $request = $this->searchRequest($order_date_from, $order_date_to, $id, $number, $customer_id, $is_closed, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($order_date_from, $order_date_to, $id = null, $number = null, $customer_id = null, $is_closed = null, $from = '0', $count = '1000', $sorting = null, $fields = null)
    {
