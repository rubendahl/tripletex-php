...
class BankApi
{
     ...
     */
    public function search($id = null, $register_numbers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $register_numbers, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     */
    public function searchWithHttpInfo($id = null, $register_numbers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBank';
        $request = $this->searchRequest($id, $register_numbers, $from, $count, $sorting, $fields);
     ...
     */
    public function searchAsync($id = null, $register_numbers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $register_numbers, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $register_numbers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseBank';
        $request = $this->searchRequest($id, $register_numbers, $from, $count, $sorting, $fields);
     ...
     */
    protected function searchRequest($id = null, $register_numbers = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
