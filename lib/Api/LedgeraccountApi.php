...
class LedgeraccountApi
{
     ...
     * @return \Tripletex\Model\ListResponseAccount
     */
    public function search($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $number, $is_bank_account, $is_inactive, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     * @return array of \Tripletex\Model\ListResponseAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccount';
        $request = $this->searchRequest($id, $number, $is_bank_account, $is_inactive, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $number, $is_bank_account, $is_inactive, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Tripletex\Model\ListResponseAccount';
        $request = $this->searchRequest($id, $number, $is_bank_account, $is_inactive, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $number = null, $is_bank_account = null, $is_inactive = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
