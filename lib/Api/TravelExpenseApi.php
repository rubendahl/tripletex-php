...
class TravelExpenseApi
{
     ...
     * @return void
     */
    public function uploadAttachment($travel_expense_id, $file = null)
    {
        $this->uploadAttachmentWithHttpInfo($travel_expense_id, $file);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadAttachmentWithHttpInfo($travel_expense_id, $file = null)
    {
        $returnType = '';
        $request = $this->uploadAttachmentRequest($travel_expense_id, $file);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentAsync($travel_expense_id, $file = null)
    {
        return $this->uploadAttachmentAsyncWithHttpInfo($travel_expense_id, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentAsyncWithHttpInfo($travel_expense_id, $file = null)
    {
        $returnType = '';
        $request = $this->uploadAttachmentRequest($travel_expense_id, $file);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadAttachmentRequest($travel_expense_id, $file = null)
    {
        // verify the required parameter 'travel_expense_id' is set
        if ($travel_expense_id === null || (is_array($travel_expense_id) && count($travel_expense_id) === 0)) {
            throw new \InvalidArgumentException(
