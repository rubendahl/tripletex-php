...
# **get**
> \Tripletex\Model\ResponseWrapperAddress get($id, $fields)
...
[**\Tripletex\Model\ResponseWrapperAddress**](../Model/ResponseWrapperAddress.md)
...
# **put**
> \Tripletex\Model\ResponseWrapperAddress put($id, $body)
...
$id = 56; // int | Element ID
$body = new \Tripletex\Model\Address(); // \Tripletex\Model\Address | Partial object describing what should be updated
...
------------- | ------------- | ------------- | -------------
 **id** | [**int**](../Model/.md)| Element ID |
 **body** | [**\Tripletex\Model\Address**](../Model/Address.md)| Partial object describing what should be updated | [optional]
...
# **search**
> \Tripletex\Model\ListResponseAddress search($id, $address_line1, $address_line2, $postal_code, $city, $name, $from, $count, $sorting, $fields)
 ...
 **address_line1** | [**string**](../Model/.md)| List of IDs | [optional]
 **address_line2** | [**string**](../Model/.md)| List of IDs | [optional]
 **postal_code** | [**string**](../Model/.md)| List of IDs | [optional]
 **city** | [**string**](../Model/.md)| List of IDs | [optional]
 **name** | [**string**](../Model/.md)| List of IDs | [optional]
...
[**\Tripletex\Model\ListResponseAddress**](../Model/ListResponseAddress.md)
